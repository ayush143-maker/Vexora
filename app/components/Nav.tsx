    ...
    <header className="sticky top-0 z-50 border-b border-border/70 bg-bg/80 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          <a
            href="#plans"
            className="rounded-md bg-accent px-4 py-2 text-sm font-medium text-[#05060a] transition-transform hover:scale-[1.03]"
          >
            Deploy a server
          </a>
        </div>
      ...
      {open && (
        <nav className="flex flex-col gap-1 border-t border-border/70 px-6 py-4 md:hidden">
          ...
          <a
            href="#plans"
            onClick={() => setOpen(false)}
            className="mt-2 rounded-md bg-accent px-4 py-2 text-center text-sm font-medium text-[#05060a]"
          >
            Deploy a server
          </a>
        </nav>
